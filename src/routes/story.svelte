<div>
	<div class="w-[90vw] m-auto text-center">
		<img src="assets\shared\mobile\image-best-gear.jpg" alt="" class="rounded-lg" />
		<h3 class="my-10 text-black">Bringing you the <span class="text-primary">best</span> audio gear</h3>
		<p>
